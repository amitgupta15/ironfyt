      ...
      return `
        ...
        <div class="nav-bar-container">
          <div class="nav-bar">
            ...
            <a class="nav-bar-item" href="workout-form.html">
              <img src="images/${pagename === 'workoutform' ? `add-circle-active.svg` : `add_circle_24dp.svg`}" />
              <div ${pagename === 'workoutform' ? 'class="nav-bar-item-active"' : ''}>Workout</div>
            </a>
