(function () {
  ...
  $test.it('should enable/disable workout time-cap fields based on time-cap switch state', function () {
    let selector = document.querySelector('#selector');
    selector.innerHTML = component.template();
    ...
    let workoutTimeCapSwitch = document.querySelector('#workout-time-cap-switch');
    workoutTimeCapSwitch.checked = true;
    $test.dispatchHTMLEvent('click', '#workout-time-cap-switch');

    $test.assert(hourInput.disabled === false);
    $test.assert(minuteInput.disabled === false);
    $test.assert(secondInput.disabled === false);

    workoutTimeCapSwitch.checked = false;
    $test.dispatchHTMLEvent('click', '#workout-time-cap-switch');
  ...
  $test.it('should enable/disable workout rounds field based on rounds switch state', function () {
    let selector = document.querySelector('#selector');
    selector.innerHTML = component.template();
    ...
    $test.assert(workoutRoundsSwitch.checked === false);
    $test.assert(workoutRoundsField.disabled === true);

    workoutRoundsSwitch.checked = true;
    $test.dispatchHTMLEvent('click', '#workout-rounds-switch');

    $test.assert(workoutRoundsSwitch.checked === true);
    $test.assert(workoutRoundsField.disabled === false);

    workoutRoundsSwitch.checked = false;
    $test.dispatchHTMLEvent('click', '#workout-rounds-switch');
  ...
  $test.it('should enable/disable workout total-reps field based on total-reps switch state', function () {
    let selector = document.querySelector('#selector');
    selector.innerHTML = component.template();
    ...
    $test.assert(workoutTotalRepsSwitch.checked === false);
    $test.assert(workoutTotalRepsField.disabled === true);

    workoutTotalRepsSwitch.checked = true;
    $test.dispatchHTMLEvent('click', '#workout-total-reps-switch');

    $test.assert(workoutTotalRepsSwitch.checked === true);
    $test.assert(workoutTotalRepsField.disabled === false);

    workoutTotalRepsSwitch.checked = false;
    $test.dispatchHTMLEvent('click', '#workout-total-reps-switch');
  ...
  $test.it('should enable/disable workout scaling field based on scaling switch state', function () {
    let selector = document.querySelector('#selector');
    selector.innerHTML = component.template();
    ...
    $test.assert(workoutScalingSwitch.checked === false);
    $test.assert(workoutScalingField.disabled === true);

    workoutScalingSwitch.checked = true;
    $test.dispatchHTMLEvent('click', '#workout-scaling-switch');

    $test.assert(workoutScalingSwitch.checked === true);
    $test.assert(workoutScalingField.disabled === false);

    workoutScalingSwitch.checked = false;
    $test.dispatchHTMLEvent('click', '#workout-scaling-switch');
